...
M8007 I15       ; the maximum rail bending speed value (corresponding to the jerk speed in the open source firmware), if the actual rail bending speed of the motion is greater than this
                ; value, will force the movement to slow down. When filling, there will be a lot of reciprocating motions, this value is large, the noise is large, and it is easy to lose
                ; steps.
                ; This value is small, slow, and print quality is relatively poor when printing speed is high
M8008 I1000     ; acceleration, the larger the value, the larger the average speed of actual operation, but the noise is also large, the value is small, and the actual speed will be
                ; smaller.
...
M8026 I155    ; Z maximum stroke, the stroke is the movement stroke of Z, be sure to use the ruler to measure it, carefully set, pause and print, the Z axis will stay at the maximum stroke
              ; position
